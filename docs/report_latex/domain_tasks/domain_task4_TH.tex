...
\begin{tabularx}{\textwidth}{|l|l|X|}
\hline
\textbf{Idiom} & \multicolumn{2}{l|}{\textbf{Bubble Scatter Plot}} \\ \hline
\textbf{What}
& \multicolumn{2}{X|}{Số lượng review: Quantitative} \\ \cline{2-3}
& \multicolumn{2}{X|}{Rating: Quantitative} \\ \cline{2-3}
& \multicolumn{2}{X|}{Reviews per month: Quantitative} \\ \cline{2-3}
& \multicolumn{2}{X|}{Loại phòng hoặc khu vực: Categorical} \\ \hline
\textbf{How}
& \textbf{Encode} &
\textbf{Mark:} Point / Circle \newline
\textbf{Channel:} \newline
\hspace*{1em} PosX: Số lượng review (Log scale) \newline
\hspace*{1em} PosY: Rating \newline
\hspace*{1em} Size: Reviews per month \newline
\hspace*{1em} Hue Color: Loại phòng hoặc khu vực \\ \cline{2-3}
& \textbf{Manipulate} &
Hover để xem listing id, rating, số lượng review, reviews per month và khu vực. \newline
Selection: Chọn một loại phòng hoặc khu vực để highlight. \\ \cline{2-3}
& \textbf{Facet} &
Có thể facet theo borough để giảm nhiễu và dễ so sánh hơn. \\ \cline{2-3}
& \textbf{Reduce} &
Có thể dùng log scale cho số lượng review nếu dữ liệu bị lệch mạnh. \newline
Lọc bỏ listing thiếu rating hoặc không có review. \\ \hline
\textbf{Why} & \multicolumn{2}{X|}{
\textbf{produce $\rightarrow$ discover, compare $\rightarrow$ summarize} \newline
Biểu đồ giúp nhận diện listing vừa có rating cao, vừa có nhiều review và vẫn được khách đánh giá thường xuyên. Đây là nhóm listing có chất lượng tốt và độ tin cậy cao.
} \\ \hline
\textbf{Scale} & \multicolumn{2}{X|}{
Main key: listing.
} \\ \hline
