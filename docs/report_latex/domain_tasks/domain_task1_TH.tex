...
\begin{itemize}
    \item Biểu đồ thể hiện rõ cấu trúc "phân hóa hướng tâm" của bất động sản New York. 
    \item Manhattan là vùng trung tâm đắt đỏ với sự tập trung dày đặc của các mảng màu xanh đậm nhất. 
    \item Mức giá có xu hướng hạ nhiệt dần ra các vùng ngoại ô như Bronx, Queens hay Staten Island.
\end{itemize}